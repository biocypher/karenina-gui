...
import { render } from '../../src/test-utils/test-helpers';
...
describe('Edge Cases Integration Tests', () => {
  ...
  describe('integ-039: Invalid state recovery', () => {
    ...
    it('should verify store reset functionality', async () => {
      const { useQuestionStore } = await import('../../src/stores/useQuestionStore');
      const { useDatasetStore } = await import('../../src/stores/useDatasetStore');
  ...
  describe('integ-036: Concurrent operations', () => {
    it('should handle rapid store operations without corruption', async () => {
      const { useDatasetStore } = await import('../../src/stores/useDatasetStore');
      const { useBenchmarkStore } = await import('../../src/stores/useBenchmarkStore');
