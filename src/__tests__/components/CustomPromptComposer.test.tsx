...
describe('CustomPromptComposer Component', () => {
  ...
  describe('Prompt Generation', () => {
    it('should generate correct prompt format with examples', async () => {
      ...
      expect(mockOnPromptGenerated).toHaveBeenCalledWith(expect.stringContaining('Custom test instructions'));
      expect(mockOnPromptGenerated).toHaveBeenCalledWith(expect.stringContaining('<examples>'));
      expect(mockOnPromptGenerated).toHaveBeenCalledWith(expect.stringContaining('<example_1>'));
      expect(mockOnPromptGenerated).toHaveBeenCalledWith(expect.stringContaining('</examples>'));
    });
  });
});
