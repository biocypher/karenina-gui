...
describe('BenchmarkTab', () => {
  ...
  it('shows empty state when no finished templates', () => {
    ...
    expect(screen.getByText('No finished templates available. Complete some templates in the curator first.')).toBeInTheDocument();
  });
  ...
  it('includes system prompts in verification config when starting benchmark', async () => {
    ...
    const answeringSystemPrompt = screen.getByDisplayValue('You are an expert assistant. Answer the question accurately and concisely.');
    const parsingSystemPrompt = screen.getByDisplayValue('You are a validation assistant. Parse and validate responses against the given Pydantic template.');
  ...
  it('allows configuration of system prompts for both models', () => {
    ...
    expect(screen.getByDisplayValue('You are an expert assistant. Answer the question accurately and concisely.')).toBeInTheDocument();
    expect(screen.getByDisplayValue('You are a validation assistant. Parse and validate responses against the given Pydantic template.')).toBeInTheDocument();
  ...
  it('allows collapsing and expanding system prompt panels', () => {
    ...
    expect(screen.queryByDisplayValue('You are an expert assistant. Answer the question accurately and concisely.')).not.toBeInTheDocument();
    expect(screen.queryByDisplayValue('You are a validation assistant. Parse and validate responses against the given Pydantic template.')).not.toBeInTheDocument();
