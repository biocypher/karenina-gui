...
describe('useLocalStorage Hook', () => {
  ...
  describe('Value Setting', () => {
    ...
    it('should handle object updates', () => {
      ...
      expect(mockLocalStorage.setItem).toHaveBeenCalledWith('test-key', JSON.stringify(updatedObject));
    });
    ...
    it('should handle array updates', () => {
      ...
      expect(mockLocalStorage.setItem).toHaveBeenCalledWith('test-key', JSON.stringify([1, 2, 3]));
    });
  });
