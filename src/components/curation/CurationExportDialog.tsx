    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
      <div className="bg-gray-800 rounded-lg p-6 max-w-md w-full border border-gray-600">
        ...
        <div className="text-xs text-gray-400 space-y-1 mb-4">
          <p>
            Curators: <span className="text-gray-200">{store.curators.length}</span>
          </p>
          <p>
            Total judgments: <span className="text-gray-200">{totalJudgments}</span>
          </p>
          <p>
            Format: <span className="text-gray-200">Standalone Curation JSON v1.0</span>
          </p>
        </div>
